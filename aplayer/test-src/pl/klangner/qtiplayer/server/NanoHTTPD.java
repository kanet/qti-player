package pl.klangner.qtiplayer.server;
...
//		return serveData( uri, header);
	...
	{
		// Allow only single instance of this class
		if(theInstance != null)
			return;
	 ...
	 * Serves data for API
	 */
	public Response serveData( String uri, Properties header)
	{
		String text = "";
		...
		return new Response( HTTP_OK, MIME_PLAINTEXT, text );
	}
	 ...
	 * Single instance
	 */
	private static NanoHTTPD theInstance = null;
